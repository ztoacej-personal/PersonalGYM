...
insert into T_Reply(id, content, writer_id, original_id, obj_type)
	values(seq4Reply_id.nextval, '홍길동야 너는 꼭 지원해줘!', 1, 2, 'reply');
insert into T_Reply(id, content, writer_id, original_id, obj_type)
	values(seq4Reply_id.nextval, '홍길동아 너도 꼭 지원해줘!', 1, 2, 'reply');

insert into T_Reply(id, content, writer_id, original_id, obj_type)
	values(seq4Reply_id.nextval, '홍길동 너 나 얼마나 기다리게 할거야?', 1, 3, 'reply');
insert into T_Reply(id, content, writer_id, original_id, obj_type)
	values(seq4Reply_id.nextval, '홍길동 너 이제는 끝이야', 1, 3, 'reply');
